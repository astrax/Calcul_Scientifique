...
\paragraph{Solution.}
Soit les trois valeurs 3, 5 et 7 assignées, respectivement, aux variables \texttt{a}, \texttt{b} et \texttt{c}:
...
\begin{block_grayiconadmon}[Interprétation]
 L'expression \texttt{a - b // c} signifie que nous voulons soustraire (signe '`-`') de la variable \texttt{a} la division entière (signe '`//`') de la variable \texttt{b} par la variable \texttt{c}. Le résultat est 3 car la division entière de 5 par 7 est égale à 0.
\end{block_grayiconadmon} % title: Interprétation
...
\noindent
\end{block_grayiconadmon} % title: Description
